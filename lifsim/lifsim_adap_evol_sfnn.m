function nn=lifsim_adap_evol_sfnn(nn, test_x, test_y, lifsim_opts, evol_opts)
dt = lifsim_opts.dt;
nn.performance = [];
...
%         nn.layers{l}.mem(nn.layers{l}.mem<0) = 0;
        % Check for spiking
